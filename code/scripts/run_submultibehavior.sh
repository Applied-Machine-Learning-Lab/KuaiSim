    ...
    do
        ...
        do
            python train_multibehavior.py\
                ...
                --val_batch_size 128\
                --cuda 0\
                --reader KRMBSeqReader_SubFB\
                --feedback_subset 0 1 2\
                ...
                --loss 'bce'\
                --l2_coef ${REG}\
                --model_path ${output_path}env/user_${MODEL}_fb012_lr${LR}_reg${REG}_nlayer${N_LAYER}.model\
                --user_latent_dim 32\
                --item_latent_dim 32\
                --enc_dim 64\
                --n_ensemble 2\
                ...
                --dropout_rate 0.1\
                > ${output_path}env/log/user_${MODEL}_fb012_lr${LR}_reg${REG}_nlayer${N_LAYER}.model.log
        done
    done
done
